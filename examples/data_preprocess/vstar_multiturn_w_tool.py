...
def process_vstar_annotation(
    ...
    if temporal_question and ground_truth_temporal_str:
        ...
        temporal_prompt = (
            ...
            f"Use the given `calc_vstar_reward` tool to test your answer before submitting final answer. "
        ...
        temporal_example = {
            "prompt": [
                {
                    ...
                    "content": (
                        ...
                        "You should use the given `calc_vstar_reward` tool at least once before generate final answer. "
            ...
            "extra_info": {
                ...
                "tools_kwargs": {
                    "calc_vstar_reward": {
                        "create_kwargs": {"ground_truth": ground_truth_temporal_str},
                        # "execute_kwargs": {},
                        # "calc_reward_kwargs": {},
                        # "release_kwargs": {},
                    },
    ...
    if spatial_question and ground_truth_spatial_str:
        ...
        spatial_example = {
            ...
            "extra_info": {
                ...
                "tools_kwargs": {
                    "calc_vstar_reward": {
                        "create_kwargs": {"ground_truth": ground_truth_spatial_str},
                        # "execute_kwargs": {},
                        # "calc_reward_kwargs": {},
                        # "release_kwargs": {},
                    },
...
def main():
    ...
    train_parquet_path = output_dir / f"{args.train_filename}{file_suffix}_{args.input_format}.parquet"
    val_parquet_path = output_dir / f"{args.val_filename}{file_suffix}_{args.input_format}.parquet"
    ...
    base_features = {
        ...
        "extra_info": {
            ...
            "tools_kwargs": {
                "calc_vstar_reward": {
                    "create_kwargs": {
                        "ground_truth": datasets.Value("string")  # Store GT as JSON string
                    },
